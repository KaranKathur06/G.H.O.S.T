...
__all__ = [
    ...
    'eLEXTYPE_PRIVATE19', 'SPDATAKEYLOCATION', 'SpInprocRecognizer',
    'SECFIgnoreKanaType', 'DISPID_SGRSTransitions',
    'SPEI_RECO_STATE_CHANGE', 'ISpeechAudioFormat', 'SPLOADOPTIONS',
    'SPPS_Modifier', 'SAFTGSM610_22kHzMono', 'eLEXTYPE_PRIVATE18',
    ...
    'DISPID_SPIAudioSizeBytes', 'SpWaveFormatEx',
    'ISpNotifyTranslator', 'DISPID_SGRsAdd', 'SPPROPERTYINFO',
    'DISPID_SRCERequestUI', 'SP_VISEME_14', 'ISpeechRecoContext',
    'DISPID_SVSCurrentStreamNumber', 'SPEI_TTS_AUDIO_LEVEL',
    'ISpMMSysAudio', 'DISPID_SpeechFileStream',
    'DISPID_SLRemovePronunciation', 'SAFT8kHz16BitMono',
    'ISpeechGrammarRuleState', 'DISPID_SpeechAudioFormat',
    'eLEXTYPE_PRIVATE2', 'ISpResourceManager',
    'SpeechAudioFormatType', 'DISPID_SpeechLexicon', 'eLEXTYPE_APP',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SAFSetWaveFormatEx',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SVSLastBookmark',
    'DISPID_SRCCreateGrammar', 'DISPID_SWFEAvgBytesPerSec',
    'SRADefaultToActive', 'SpPhraseInfoBuilder',
    'DISPID_SRRTOffsetFromStart', 'eLEXTYPE_RESERVED7',
    'DISPID_SPIEngineId', 'SpLexicon', 'DISPID_SRCResume',
    'ISpObjectWithToken', 'DISPID_SVEWord', 'DISPID_SRCESoundEnd',
    'SPPS_Interjection', 'SPAO_NONE', 'SPPS_NotOverriden',
    'SPPHRASERULE', 'DISPID_SpeechVoiceStatus', 'SREStreamEnd',
    'DISPID_SRRTimes', 'DISPID_SPRs_NewEnum',
    'ISpeechPhraseInfoBuilder', 'SWTAdded', 'DISPID_SLWWord',
    'DISPID_SVEViseme', 'SGRSTTTextBuffer', 'DISPID_SPCIdToPhone',
    'DISPID_SpeechLexiconWord', 'DISPID_SOTRemove', 'SVSFIsNotXML',
    'SVP_10', 'SVPNormal', 'SPCATEGORYTYPE',
    'DISPID_SRCEInterference', 'DISPID_SLWsItem', 'SPCT_SUB_COMMAND',
    'DISPID_SpeechAudio', 'SAFT12kHz16BitStereo',
    'DISPID_SRRTTickCount', 'SDTProperty', '__MIDL_IWinTypes_0009',
    'SVP_16', 'DISPID_SRGState', 'SDTReplacement', 'SVEAllEvents',
    'SDA_Consume_Leading_Spaces', 'DISPID_SVWaitUntilDone',
    'SpeechRuleState', 'SPSLMA', 'DISPID_SOTCGetDataKey',
    'ISpeechLexicon', 'SWPUnknownWordPronounceable',
    'DISPID_SRRSpeakAudio', 'ISpeechGrammarRules',
    'SAFTADPCM_22kHzMono', 'DISPID_SLPSymbolic', 'SAFT8kHz8BitMono',
    'eLEXTYPE_RESERVED8', 'SGSEnabled', 'SPAR_Low',
    'DISPID_SDKSetLongValue', 'DISPID_SRCSetAdaptationData',
    'SECFIgnoreCase', 'DISPID_SGRs_NewEnum', 'SpCompressedLexicon',
    'SpeechTokenKeyFiles', 'DISPID_SAFGuid', 'SDTRule',
    'SREAllEvents', 'DISPIDSPTSI_SelectionLength', 'SPAS_CLOSED',
    'eLEXTYPE_USER_SHORTCUT', 'ISpeechLexiconPronunciations',
    'SPPS_RESERVED4', 'SAFT11kHz8BitStereo', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SMSSetData', 'DISPID_SRRecognizer', 'IEnumString',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SLWsCount', 'SPEI_MIN_SR',
    'SpStreamFormatConverter', 'DISPID_SPIEnginePrivateData',
    'DISPID_SRSCurrentStreamPosition', 'SPRECOSTATE',
    'ISpeechBaseStream', 'SAFT48kHz8BitStereo', 'SGRSTTRule',
    'SPFM_OPEN_READONLY', 'SREStateChange', 'DISPID_SVSLastResult',
    'eLEXTYPE_RESERVED4', 'DISPID_SVSpeakCompleteEvent', 'SBONone',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRSetPropertyString',
    'DISPID_SPRuleId', 'SPSHORTCUTPAIRLIST', 'DISPID_SRCPause',
    'SP_VISEME_3', 'ISpeechRecognizer', 'SRSEDone',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SPRuleName',
    'DISPID_SPPValue', 'DISPID_SGRSAddSpecialTransition',
    'SPBOOKMARKOPTIONS', 'SAFT44kHz16BitMono', 'SVSFUnusedFlags',
    'SREAdaptation', 'SPPS_Verb', 'DISPID_SPARecoResult',
    'SWPUnknownWordUnpronounceable', 'SPSHORTCUTPAIR', 'SVP_20',
    'SDKLDefaultLocation', 'SVEBookmark', 'SAFTADPCM_44kHzMono',
    'SpSharedRecoContext', 'SPEI_SR_RETAINEDAUDIO', 'SP_VISEME_1',
    'DISPID_SpeechDataKey', 'IStream', 'SAFT24kHz8BitMono',
    'DISPID_SpeechPhraseProperties', 'DISPID_SpeechRecoContext',
    'ISpNotifySink', 'ISpeechObjectToken', 'eLEXTYPE_PRIVATE13',
    'SPINTERFERENCE_NOSIGNAL', 'SpeechRecoEvents',
    'DISPID_SRCVoicePurgeEvent', 'SFTInput', 'eLEXTYPE_PRIVATE12',
    'DISPID_SVGetVoices', 'SGSDisabled', 'SSFMOpenForRead',
    'DISPID_SDKGetlongValue', 'DISPID_SDKDeleteValue',
    'DISPID_SVPause', 'DISPID_SGRSRule', 'ISpPhraseAlt',
    'DISPID_SVEventInterests', 'ISpPhrase', 'DISPID_SVEAudioLevel',
    'DISPID_SPPsCount', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SLWType', 'SSFMCreateForWrite', 'SPWAVEFORMATTYPE',
    'SPBO_NONE', 'eLEXTYPE_MORPHOLOGY', 'SGRSTTWord',
    'SDKLCurrentUser', 'SPEI_RESERVED2', 'WAVEFORMATEX',
    'SP_VISEME_4', 'SPINTERFERENCE_NONE',
    'SpeechStreamSeekPositionType', 'SPINTERFERENCE_TOOSLOW',
    'SVSFlagsAsync', 'ISpXMLRecoResult', 'SPSEMANTICERRORINFO',
    'tagSPTEXTSELECTIONINFO', 'SpAudioFormat', 'SpeechDiscardType',
    ...
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SVEStreamStart', 'SVP_14',
    'SpeechRegistryLocalMachineRoot', 'SPRS_ACTIVE_USER_DELIMITED',
    'SVEPrivate', 'ISpRecoResult', 'SpeechPropertyAdaptationOn',
    'SPEI_START_SR_STREAM', 'SpeechRecoContextState',
    'DISPID_SPEs_NewEnum', 'SVEViseme', 'SVP_5', 'DISPID_SRState',
    'SPTEXTSELECTIONINFO', 'SPEVENTENUM', 'SpeechUserTraining',
    'DISPID_SRCESoundStart', 'SVP_11', 'DISPID_SLGetWords',
    'SP_VISEME_18', 'SPDKL_LocalMachine',
    'SpeechCategoryRecoProfiles', 'SITooLoud', 'DISPID_SpeechVoice',
    'SVP_1', 'SPWORDPRONUNCIATIONLIST', 'ISpeechPhraseElement',
    'SAFT8kHz8BitStereo', 'DISPID_SPRuleNumberOfElements',
    'SPEI_SENTENCE_BOUNDARY', 'SPINTERFERENCE_NOISE', 'SPCS_ENABLED',
    'SPEI_END_SR_STREAM', 'DISPID_SRGRules', 'SINoise',
    'SPWT_LEXICAL', 'ISpRecognizer', 'SPPS_LMA', 'DISPID_SRGCommit',
    'DISPID_SOTs_NewEnum', 'DISPID_SRAudioInput',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SVEBookmark',
    'eLEXTYPE_PRIVATE9', 'SGDSActiveWithAutoPause', 'SVEVoiceChange',
    'DISPID_SRRAlternates', '_RemotableHandle', 'SpMMAudioOut',
    ...
    'DISPID_SOTsItem', 'SRESoundEnd', 'SPEI_RESERVED1',
    ...
    'DISPID_SPEAudioTimeOffset', 'SRTEmulated',
    'SpeechEngineProperties', 'DISPID_SPRText',
    'DISPID_SPPNumberOfElements', 'SPEI_MIN_TTS',
    'DISPID_SRCRetainedAudio', 'DISPID_SGRSAddRuleTransition',
    'SpeechLexiconType', 'DISPID_SOTCEnumerateTokens', 'SPPS_Unknown',
    'SPSHT_Unknown', '_ISpeechRecoContextEvents', 'DISPID_SVSpeak',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SDKGetStringValue',
    'SPLO_DYNAMIC', 'DISPID_SVEPhoneme', 'DISPID_SPEPronunciation',
    'SpeechPropertyResponseSpeed', 'ISpRecoGrammar',
    'SPEI_VOICE_CHANGE', 'eLEXTYPE_PRIVATE17',
    'DISPID_SGRSTs_NewEnum', 'SVEPhoneme', 'ISpeechRecoResultTimes',
    'DISPID_SASState', 'SRERecognition', 'DISPID_SVSInputWordLength',
    'SpeechGrammarTagDictation', 'SPBO_TIME_UNITS',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SPPsItem', 'SLTApp',
    'ISpeechAudioBufferInfo', 'DISPID_SAEventHandle',
    'SPPS_RESERVED2', 'ISpeechPhraseInfo', 'DISPID_SRCRecognizer',
    'SPVPRI_NORMAL', 'SpeechTokenContext', 'DISPID_SVSpeakStream',
    'SpeechBookmarkOptions', 'SPFILEMODE', 'SVESentenceBoundary',
    'SVP_13', 'SPSTREAMFORMATTYPE', 'SREFalseRecognition',
    'DISPID_SWFEFormatTag', 'SSSPTRelativeToEnd',
    'SAFT16kHz16BitStereo', 'SRTSMLTimeout', 'STCRemoteServer',
    'DISPID_SLGenerationId', 'DISPID_SPIElements',
    'DISPID_SDKCreateKey', 'DISPID_SpeechGrammarRule',
    'DISPID_SVEStreamEnd', 'ISequentialStream', 'ISpeechRecoResult',
    'DISPID_SRGCmdLoadFromFile', 'SPVISEMES', 'SVSFParseSsml',
    'DISPID_SRCEPhraseStart', 'STSF_AppData', 'SP_VISEME_11',
    'SRSInactiveWithPurge', 'SVEAudioLevel',
    'ISpeechPhraseReplacement', 'SGDisplay', 'DISPID_SGRSTNextState',
    'SVSFNLPMask', 'DISPID_SPRuleParent', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SDKGetBinaryValue', 'SVP_2', 'DISPID_SRRTStreamTime',
    'SpeechTokenShellFolder', 'DISPID_SPRNumberOfElements',
    'DISPID_SWFESamplesPerSec', 'SRAONone', 'SP_VISEME_19',
    'SAFTNonStandardFormat', 'SPGS_DISABLED', 'tagSTATSTG',
    'eLEXTYPE_PRIVATE1', 'DISPID_SRGRecoContext',
    'SPSERIALIZEDPHRASE', 'eLEXTYPE_PRIVATE4', 'SPCONTEXTSTATE',
    'DISPID_SABIBufferSize', 'SPEI_PHONEME', 'SRAORetainAudio',
    'SPGRAMMARWORDTYPE', 'SpeechRunState', 'DISPID_SRRTLength',
    'SDA_Two_Trailing_Spaces', 'ISpStream',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SPIAudioSizeTime',
    'DISPID_SBSRead', 'DISPID_SVStatus', 'DISPID_SPEsCount',
    'DISPID_SRIsShared', 'SPGS_ENABLED', 'STSF_CommonAppData',
    'DISPID_SPEAudioSizeBytes', 'ISpeechDataKey',
    'SPWORDPRONOUNCEABLE', 'SAFTCCITT_uLaw_11kHzStereo', 'SPSUnknown',
    'SVSFParseMask', 'tagSPPROPERTYINFO', 'DISPID_SPAsCount',
    'SREInterference', 'DISPID_SPEAudioStreamOffset',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPRST_NUM_STATES',
    'SPEI_INTERFERENCE', 'DISPID_SpeechMemoryStream', 'SGSExclusive',
    'SVP_0', 'SAFT12kHz16BitMono', 'SPSERIALIZEDRESULT',
    'ISpeechMMSysAudio', 'DISPID_SPRDisplayAttributes',
    'SPFM_CREATE_ALWAYS', 'DISPID_SLGetPronunciations',
    'SAFT11kHz16BitStereo', 'SAFT24kHz16BitMono', 'SPRECORESULTTIMES',
    'DISPID_SpeechAudioStatus', 'SSTTWildcard', 'ISpNotifySource',
    'DISPID_SRCEPropertyNumberChange', 'SVPOver',
    '_ISpeechVoiceEvents', 'SSSPTRelativeToCurrentPosition',
    'SPAS_STOP', 'SPEI_RECO_OTHER_CONTEXT', 'SGDSInactive',
    'DISPID_SGRSTWeight', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SOTCategory',
    'DISPID_SGRAddState', 'SpeechCategoryPhoneConverters',
    'DISPID_SLPLangId', 'DISPID_SPEDisplayText',
    'ISpObjectTokenCategory', 'SPBO_AHEAD', 'SP_VISEME_5',
    'DISPID_SPRuleFirstElement', 'DISPID_SVSPhonemeId',
    'SPSInterjection',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpStreamFormatConverter', 'SAFTText',
    'DISPID_SpeechPhraseReplacements', 'SpeechRecognizerState',
    'SpCustomStream', 'SVP_4', 'eLEXTYPE_USER', 'SSTTTextBuffer',
    'SPEI_MAX_TTS', 'DISPID_SPEDisplayAttributes', 'SVP_3',
    'SpShortcut', 'DISPIDSPTSI_ActiveOffset', 'DISPID_SPAsItem',
    'ISpeechLexiconPronunciation', 'SITooQuiet',
    'DISPID_SPEAudioSizeTime', 'DISPID_SpeechObjectToken',
    'SVSFPersistXML', 'SPGS_EXCLUSIVE', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SOTGetStorageFileName', 'SpeechVisemeFeature',
    'ISpeechAudioStatus', 'eLEXTYPE_PRIVATE20',
    'SVSFPurgeBeforeSpeak', 'SAFT22kHz16BitMono', 'SREStreamStart',
    'SVP_12', 'DISPID_SRCEFalseRecognition', 'SAFTGSM610_44kHzMono',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SGRSTPropertyValue',
    'DISPID_SPANumberOfElementsInResult', 'SVP_17',
    'DISPID_SABufferInfo', 'SPWORDLIST', 'SAFT12kHz8BitMono',
    'SPRECOCONTEXTSTATUS', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPEI_SR_PRIVATE', 'eLEXTYPE_PRIVATE10', 'STSF_FlagCreate',
    'SPRULESTATE', 'SpeechPropertyResourceUsage',
    ...
    'ISpRecoContext', 'DISPID_SPAPhraseInfo', 'SPPS_Noncontent',
    'DISPID_SBSWrite', 'SRSInactive', 'SPAUDIOOPTIONS', 'SVP_9',
    'DISPID_SOTCId', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SPRules_NewEnum', 'SpNotifyTranslator',
    'DISPID_SpeechPhraseElement', 'DISPID_SASCurrentDevicePosition',
    'SAFT48kHz16BitMono', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPEI_UNDEFINED', 'SpeechCategoryRecognizers', 'SPAR_Unknown',
    'DISPID_SVSLastStreamNumberQueued', 'SPAR_High',
    'SAFT22kHz8BitMono', 'SDA_One_Trailing_Space', 'SRTAutopause',
    'SVPAlert', 'SINoSignal', 'SpeechPropertyComplexResponseSpeed',
    'SPRS_INACTIVE', 'SpeechAddRemoveWord', 'DISPID_SOTIsUISupported',
    'DISPID_SPPId', 'SGDSActiveUserDelimited', 'SpeechVoiceEvents',
    'DISPID_SAFGetWaveFormatEx', 'SAFTADPCM_8kHzStereo',
    'DISPID_SCSBaseStream', 'SpeechTokenValueCLSID',
    'DISPID_SPISaveToMemory', 'SRAExport', 'SPPS_SuppressWord',
    'SP_VISEME_10', 'SpStream', 'SPXMLRESULTOPTIONS',
    'SAFT48kHz16BitStereo', 'ISpeechPhraseAlternates',
    'SREPropertyStringChange', 'DISPID_SpeechPhraseInfo',
    'DISPID_SAFType', 'SPAS_RUN', 'SAFT11kHz16BitMono',
    'SP_VISEME_17', 'SpeechEmulationCompareFlags', 'DISPID_SGRSTType',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRCEAudioLevel',
    'SpeechDisplayAttributes', 'ISpeechGrammarRule',
    'DISPID_SPPBRestorePhraseFromMemory', 'IInternetSecurityMgrSite',
    'DISPID_SRGetPropertyNumber', 'SP_VISEME_13',
    'DISPID_SRRGetXMLErrorInfo', 'SpeechDataKeyLocation',
    'SAFT44kHz8BitMono', 'DISPID_SPEEngineConfidence',
    'SAFTExtendedAudioFormat', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'ISpGrammarBuilder', 'ISpPhoneticAlphabetSelection',
    'DISPID_SOTsCount', 'SPADAPTATIONRELEVANCE', 'DISPID_SGRsCommit',
    'DISPID_SOTDisplayUI', 'DISPID_SLAddPronunciation',
    'SpeechGrammarTagWildcard', 'SVP_7', 'SAFTCCITT_ALaw_11kHzStereo',
    'ISpPhoneticAlphabetConverter', 'SpeechFormatType',
    'DISPID_SFSOpen', 'ISpeechVoiceStatus', 'SLODynamic',
    'DISPID_SRRRecoContext', 'SPAUDIOBUFFERINFO',
    'SECNormalConfidence', 'SAFTCCITT_ALaw_11kHzMono',
    'SVSFVoiceMask', 'SRSActive', 'SpeechAudioProperties',
    'SVSFNLPSpeakPunc', 'DISPID_SRGDictationLoad',
    'DISPID_SpeechPhraseReplacement', 'SpeechAudioState',
    'ISpeechPhraseRules', 'SpeechGrammarState', 'DISPID_SDKOpenKey',
    'SPFM_CREATE', 'DISPID_SRIsUISupported', 'DISPID_SGRSTsItem',
    'SRSEIsSpeaking', 'DISPID_SABIEventBias', 'ISpRecoGrammar2',
    ...
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPDKL_CurrentConfig',
    'DISPID_SRCEPropertyStringChange', 'SpeechRecognitionType',
    'ISpVoice', 'SPEI_RESERVED5', 'DISPID_SGRSTPropertyName',
    'SPWORD', 'SP_VISEME_2', 'SVP_6', 'DISPID_SRCEAdaptation',
    'SRTExtendableParse', 'DISPID_SRStatus', 'SPCT_SLEEP',
    'ISpeechVoice', 'DISPID_SpeechPhraseProperty', 'SpMMAudioEnum',
    'SpObjectToken', 'SAFTDefault', 'SAFT11kHz8BitMono', 'SVSFIsXML',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_VENDORLEXICON', 'ISpRecognizer3',
    'DISPID_SpeechLexiconPronunciation', 'SP_VISEME_16',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRGCmdSetRuleIdState',
    'SECFNoSpecialChars', 'SRERecoOtherContext', 'SGDSActive',
    'SPEI_SR_BOOKMARK', 'SLTUser', 'SpeechAudioFormatGUIDWave',
    'DISPID_SpeechBaseStream', 'ISpeechResourceLoader',
    'SDTAlternates', 'DISPID_SPIRetainedSizeBytes',
    'eWORDTYPE_DELETED', 'DISPID_SPRsCount', 'DISPID_SRGId',
    'DISPID_SRGDictationSetState', 'SpeechTokenKeyUI',
    'DISPID_SGRAttributes', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SAFT16kHz8BitStereo', 'SAFT32kHz8BitStereo', 'SVEEndInputStream',
    'SPRS_ACTIVE', 'DISPID_SGRSTPropertyId', 'DISPID_SMSADeviceId',
    'SPLEXICONTYPE', 'DISPID_SRCRequestedUIType', 'SECFIgnoreWidth',
    'SVSFParseSapi', 'SpPhoneConverter', '_SPAUDIOSTATE',
    'DISPID_SABIMinNotification', 'DISPID_SABufferNotifySize',
    'DISPID_SVAudioOutput', 'DISPID_SLPPhoneIds',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SRCERecognition',
    'SPLO_STATIC', 'DISPID_SPPParent', 'SAFTCCITT_ALaw_22kHzMono',
    ...
    'SpeechVoiceSkipTypeSentence', 'SRADynamic',
    'Speech_Max_Word_Length',
    'DISPID_SpeechGrammarRuleStateTransitions', 'eWORDTYPE_ADDED',
    'SpeechTokenKeyAttributes', 'SPWORDTYPE', 'SPVPRI_ALERT',
    'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'ISpeechObjectTokenCategory', 'SpNullPhoneConverter',
    'SPEI_WORD_BOUNDARY', 'DISPID_SOTCDefault', 'SPRULE',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPPS_RESERVED1', 'SREBookmark',
    'SPEI_PHRASE_START', 'ISpeechPhraseReplacements',
    'SAFT44kHz8BitStereo', 'DISPID_SVDisplayUI',
    'DISPID_SPEActualConfidence', 'SRAImport', 'SPSNotOverriden',
    'SPEI_ADAPTATION', 'DISPID_SRCEEndStream',
    'SpeechCategoryAudioOut', 'DISPID_SGRsItem', 'eLEXTYPE_PRIVATE3',
    'DISPID_SVSRunningState', 'DISPID_SpeechPhoneConverter',
    'SPWORDPRONUNCIATION', 'DISPID_SREmulateRecognition',
    'SAFT8kHz16BitStereo', 'DISPID_SRDisplayUI', 'eLEXTYPE_PRIVATE14',
    'DISPID_SBSFormat', 'SpResourceManager', 'Speech_StreamPos_Asap',
    'SAFT32kHz16BitStereo', 'SAFTCCITT_uLaw_8kHzMono',
    'SSFMOpenReadWrite', 'DISPID_SVRate',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPEI_PROPERTY_NUM_CHANGE', 'SAFT32kHz16BitMono',
    'DISPID_SGRsDynamic', 'DISPID_SRRAudio', 'DISPID_SLPsCount',
    'SPEI_RECOGNITION', 'SDTPronunciation', 'ISpeechPhraseAlternate',
    'SpeechRetainedAudioOptions', 'DISPID_SRGetFormat',
    'SPWT_PRONUNCIATION', 'SP_VISEME_6', 'DISPID_SDKEnumValues',
    'SVP_19', 'DISPID_SVIsUISupported',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SRRSetTextFeedback',
    'ISpLexicon', 'DISPID_SRCBookmark', 'DISPID_SPPChildren',
    'SPEVENTSOURCEINFO', 'eLEXTYPE_PRIVATE11', 'DISPID_SRProfile',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SPERequiredConfidence', 'SpVoice', 'DISPID_SGRsCount',
    'SpeechInterference', 'SGLexical', 'DISPID_SVAudioOutputStream',
    'DISPID_SVESentenceBoundary', 'DISPID_SPEsItem',
    'DISPID_SRSCurrentStreamNumber', 'SP_VISEME_20',
    'ISpeechMemoryStream', 'ISpeechPhraseElements',
    'DISPID_SRCreateRecoContext', 'Speech_Max_Pron_Length',
    'SPEI_TTS_PRIVATE', 'DISPID_SPIProperties',
    'DISPID_SPIAudioStreamPosition', 'eLEXTYPE_RESERVED9',
    'DISPID_SAStatus', 'SPEI_RESERVED3', 'SPPS_RESERVED3',
    'SPEI_MAX_SR', 'DISPID_SPRuleEngineConfidence', 'SPPS_Noun',
    'SRESoundStart', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SITooFast', 'SpeechAllElements', 'ISpeechLexiconWords',
    'SAFT22kHz8BitStereo', 'SPBINARYGRAMMAR', 'SP_VISEME_7',
    'DISPID_SGRSTRule', 'SpeechRuleAttributes', 'eLEXTYPE_PRIVATE8',
    'STCInprocServer', 'SAFTADPCM_11kHzStereo', 'DISPID_SOTCSetId',
    'eLEXTYPE_PRIVATE6', 'STCInprocHandler', 'STCLocalServer',
    'SpeechVisemeType', 'DISPID_SMSALineId',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRGSetTextSelection',
    'SDKLLocalMachine', 'SpMMAudioIn', 'SAFTADPCM_8kHzMono',
    'DISPID_SOTDataKey', 'DISPID_SpeechRecoContextEvents',
    'SPSModifier', 'SPXRO_SML', 'DISPID_SRCEStartStream',
    'eLEXTYPE_PRIVATE16', 'SpeechMicTraining',
    'SpUnCompressedLexicon', 'SpeechCategoryAudioIn',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPIDSPRG', 'SP_VISEME_9',
    'DISPID_SGRClear', 'DISPID_SOTMatchesAttributes', 'SPPHRASE',
    'SPDKL_DefaultLocation', 'SPINTERFERENCE',
    'DISPIDSPTSI_ActiveLength', 'SPSFunction', 'DISPID_SFSClose',
    'SPSSuppressWord', 'SPEI_REQUEST_UI', 'ISpeechRecognizerStatus',
    'SPGRAMMARSTATE', 'SINone', 'DISPID_SpeechMMSysAudio',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'ISpeechRecoResultDispatch', 'SPAUDIOSTATE',
    'Speech_Default_Weight', 'SPWF_SRENGINE', 'SASStop',
    'SSSPTRelativeToStart', 'SPINTERFERENCE_LATENCY_WARNING',
    'SGRSTTWildcard', 'DISPID_SpeechObjectTokens',
    'DISPID_SRGDictationUnload', 'DISPID_SASNonBlockingIO',
    'SREPropertyNumChange', 'SP_VISEME_12', 'SECFDefault',
    'SPCT_COMMAND', 'SVEWordBoundary', 'DISPID_SpeechPhraseElements',
    'SGRSTTEpsilon', 'DISPID_SVAlertBoundary', 'SPVPRIORITY',
    'SREAudioLevel', 'DISPID_SRCEHypothesis', 'SPRST_ACTIVE',
    'SPSNoun', 'SPINTERFERENCE_TOOFAST', 'UINT_PTR',
    ...
    'DISPID_SRGReset', 'LONG_PTR', 'SAFTADPCM_11kHzMono',
    'DISPID_SPAStartElementInResult', 'SP_VISEME_21',
    'DISPID_SRCVoice', 'SDKLCurrentConfig', 'DISPID_SRRAudioFormat',
    'DISPID_SpeechRecognizer', 'SAFT22kHz16BitStereo',
    'SPFM_NUM_MODES', 'SPEI_VISEME', 'SAFTGSM610_8kHzMono',
    'DISPID_SASetState', 'DISPID_SPIStartTime', 'DISPID_SOTSetId',
    'SAFTCCITT_ALaw_8kHzStereo', 'SAFT44kHz16BitStereo', 'SPEVENT',
    'SVF_Stressed', 'DISPID_SGRId', 'SWPKnownWordPronounceable',
    'SRAInterpreter', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SPPFirstElement', 'SREPhraseStart',
    'ISpeechPhraseProperty', 'DISPID_SAVolume',
    'DISPID_SpeechPhraseAlternates', 'SVP_18',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SPPConfidence',
    'SpeechWordType', 'SPINTERFERENCE_TOOLOUD', 'DISPID_SWFEChannels',
    'ISpeechTextSelectionInformation', 'DISPID_SPRulesItem',
    'ISpeechPhraseRule', 'eLEXTYPE_PRIVATE15',
    'DISPID_SGRInitialState', 'SPPARTOFSPEECH', 'SpeechVoicePriority',
    'SPPHRASEREPLACEMENT', 'ISpeechRecoGrammar',
    'DISPID_SpeechRecoResult2', 'SVSFDefault', 'ISpeechAudio',
    'SPEI_RESERVED6', 'DISPID_SVPriority', 'SpeechStreamFileMode',
    'DISPID_SLPPartOfSpeech', 'SPSHT_OTHER', 'SpSharedRecognizer',
    'DISPID_SRGetPropertyString', 'eLEXTYPE_PRIVATE7',
    'SRCS_Disabled', 'SpeechSpecialTransitionType',
    ...
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SRGSetWordSequenceData',
    'SAFT16kHz16BitMono', 'DISPID_SPAs_NewEnum', 'DISPID_SLPType',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPSMF_UPS', 'SECHighConfidence',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRRPhraseInfo', 'SPAR_Medium', 'DISPID_SRRSaveToMemory',
    'ISpPhoneConverter', 'DISPID_SLWLangId',
    'SpeechTokenIdUserLexicon', 'SVP_21', 'ISpeechWaveFormatEx',
    'DISPID_SRCEBookmark', 'DISPID_SOTId', 'DISPID_SGRAddResource',
    'SpObjectTokenCategory', 'DISPID_SVSkip', 'SFTSREngine',
    'DISPID_SLGetGenerationChange', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRSetPropertyNumber', 'SpMemoryStream',
    'SpeechCategoryVoices', 'SAFT32kHz8BitMono', 'DISPID_SPRsItem',
    'SRERequestUI', 'SREHypothesis', 'SLOStatic', 'SRTReSent',
    'SASPause', 'DISPID_SVSyncronousSpeakTimeout', 'SASClosed',
    'DISPID_SVGetAudioOutputs', 'DISPID_SPCLangId',
    'SPDKL_CurrentUser', 'SpInProcRecoContext',
    'DISPID_SVEVoiceChange', 'DISPID_SGRSAddWordTransition',
    'SDTDisplayText', 'SPEI_SR_AUDIO_LEVEL', 'SWTDeleted',
    'DISPID_SVSInputSentencePosition', 'DISPID_SLWs_NewEnum',
    'SDTAudio', 'SVEStartInputStream', 'DISPID_SPPs_NewEnum',
    'ISpEventSink', 'IInternetSecurityManager', 'SASRun',
    'DISPID_SRGetRecognizers', 'DISPID_SLPsItem', 'ISpSerializeState',
    'DISPID_SPCPhoneToId', 'DISPID_SGRSTsCount',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SOTGetDescription',
    'DISPID_SVGetAudioInputs', 'SBOPause', 'SRCS_Enabled',
    'DISPID_SGRsFindRule', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPFM_OPEN_READWRITE', 'DISPID_SRCCmdMaxAlternates',
    'SPCT_DICTATION', 'DISPID_SVGetProfiles',
    ...
    'DISPID_SWFEBitsPerSample', 'SVP_15', 'SAFTGSM610_11kHzMono',
    'SPSVerb', 'SPEI_SOUND_END', 'SPAO_RETAIN_AUDIO',
    'DISPID_SVSVisemeId', 'DISPID_SADefaultFormat',
    'DISPID_SPIGetText', 'DISPID_SPIGetDisplayAttributes', 'ISpAudio',
    'SPCS_DISABLED', 'SPEI_FALSE_RECOGNITION', 'DISPIDSPTSI',
    'DISPID_SRRGetXMLResult', 'DISPID_SGRSTText',
    'DISPID_SRSSupportedLanguages', 'SpeechWordPronounceable',
    'Speech_StreamPos_RealTime', 'DISPID_SBSSeek', 'SP_VISEME_8',
    'ISpRecoContext2', 'SVSFParseAutodetect',
    'SAFTCCITT_uLaw_22kHzMono', 'SPWF_INPUT', 'SP_VISEME_15',
    'SAFT12kHz8BitStereo', 'SRSActiveAlways', 'SAFT24kHz8BitStereo',
    'DISPID_SLWPronunciations', 'ISpProperties',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SPRulesCount',
    'SPPHRASEPROPERTY', 'SVF_None', 'DISPID_SVSInputWordPosition',
    'SPSEMANTICFORMAT', 'SECLowConfidence', 'SpeechAudioVolume',
    'SRTStandard', 'SPBO_PAUSE', 'SPEI_HYPOTHESIS',
    'SPEI_SOUND_START', 'ISpeechObjectTokens', 'ISpObjectToken',
    'SpTextSelectionInformation', 'SPCT_SUB_DICTATION',
    'SpeechPropertyHighConfidenceThreshold', 'SPVOICESTATUS',
    'DISPID_SWFEExtraData', 'SRARoot', 'SpeechLoadOption',
    'SVF_Emphasis', 'SPSHT_EMAIL', 'eLEXTYPE_PRIVATE5', 'SSFMCreate',
    'ISpEventSource', 'SP_VISEME_0', 'DISPID_SRSAudioStatus',
    'DISPID_SPRuleChildren', 'SPEI_START_INPUT_STREAM',
    'ISpeechXMLRecoResult', 'SPEI_TTS_BOOKMARK',
    'DISPID_SpeechPhraseRules', 'SpPhoneticAlphabetConverter',
    'DISPID_SpeechCustomStream', 'SAFTNoAssignedFormat',
    'SSTTDictation', 'DISPID_SVVoice', 'SpFileStream',
    'DISPID_SPPEngineConfidence', 'SPWT_DISPLAY',
    'DISPID_SVSLastBookmarkId', 'ISpDataKey', 'ISpRecoCategory',
    'ISpeechLexiconWord', 'DISPID_SRSClsidEngine', 'SDTAll',
    'eLEXTYPE_RESERVED10', 'SAFTADPCM_22kHzStereo',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SpeechPhraseRule',
    'ISpeechFileStream', 'DISPID_SpeechVoiceEvent',
    'SpeechEngineConfidence', 'DISPID_SRCState',
    'DISPID_SOTGetAttribute', 'DISPID_SASCurrentSeekPosition',
    ...
    'SDTLexicalForm', 'DISPID_SGRName', 'DISPID_SpeechGrammarRules',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SDKSetBinaryValue',
    'SPSHORTCUTTYPE', 'STCAll', 'SVSFIsFilename',
    'DISPID_SRAudioInputStream', 'DISPID_SVResume', 'SPPHRASEELEMENT',
    'SPRECOGNIZERSTATUS', 'DISPID_SPIRule', 'SREPrivate',
    'DISPID_SpeechLexiconWords', 'SAFT24kHz16BitStereo',
    'ISpeechCustomStream', 'SRATopLevel', 'SPAUDIOSTATUS',
    'DISPID_SPPName', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SMSAMMHandle', 'DISPID_SPRuleConfidence', 'SVP_8',
    'SPRST_INACTIVE'
]

_check_version('1.2.0', 1701657989.690187)
